...
namespace GeekShopping.CartAPI.Repository
{
  public class CartRepository : ICartRepository
  {
    ...
    public async Task<CartVO> SaveOrUpdateCart(CartVO cartVO)
    {
      ...
      // Checks if the product is already saved in the database
      // If it does not existes then save it
      ...
      if (cartHeader == null)
      {
        ...
        _context.CartDetails.FirstOrDefault().Product = null;
      ...
      else
      {
        ...
        else
        {
          ...
          cart.CartDetails.FirstOrDefault().Product = null;
          cart.CartDetails.FirstOrDefault().Count = cartVO.CartDetails.FirstOrDefault().Count;
